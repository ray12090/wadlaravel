...
<head>
    ...
    <!-- Favicon -->
    <link href="/public/foto/Logo kios tani.png" rel="icon">
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <h1 class="fw-bold text-primary mb-4"><span class="text-secondary">Kios</span>Tani</h1>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-end">
                        ...
                        <br>Distributed By: <a href="" target="_blank">Kelompok 9</a>
                    </div>
                </div>
            </div>
        </div>
